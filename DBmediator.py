...
class DBmediator:
    ...
    def check_signin(self, Username, Password):
        ...
        try:
            if self.dosql(sql, (Username, Password)) != (): #user found with the given username and password
                ret.success = True
    ...
    def getuser(self, Userid):
        ...
        try:
            ...
            ret.data = User(Userid=userid, Username=username, Kudos=kudos, Admin=admin, Followers=followers, Followees=followees)
            ret.success = True
            ret.msg = "Success!"
        except:
            ret.success = False
    ...
    def increasesubmissionscount(self, Questionid):
        ...
        currentcount = self.dosql("Select Submissionscount from Questions where Questionid=%s", (Questionid, ))[0]['Submissionscount']
    ...
    def increasecorrectsubmissionscount(self, Questionid):
        ...
        currentcount = self.dosql("Select Correctsubmissionscount from Questions where Questionid=%s", (Questionid, ))[0]['Correctsubmissionscount']
    ...
    def getallusers(self, exclude=(), follower=-1, followee=-1):
        ...
        try:
            ...
            for user in allusers:
                ...
                if (follower == -1 or follower in u.Followers) and (followee == -1 or followee in u.Followees):
                    ret.data.append(u)
            ret.success = True
            ret.msg = "Success!"
        except:
    ...
    def getverificationurl(self, Userid):
        ...
        try:
            ...
            if data == ():
                ...
                ret.data = "http://127.0.0.1:5000/verifyuser/" + str(Userid) + "/" + data[0]['Secretkey']
                print (ret.data)
            ret.success = True
        except:
            ret.success = False
    ...
    def isverificationexpired(self, Userid):
        ...
        try:
            ...
            if data < current_time: ret.data = True
            ret.success = True
            ret.msg = "Success!"
        except:
            ret.success = False
